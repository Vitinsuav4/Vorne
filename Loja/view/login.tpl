			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form class="login100-form validate-form" method="post">
					...
					<a href="#" class="btn-google m-b-10">
						<img src="{$GET_SITE_HOME}/lib/paginas/login/images/icons/icon-google.png" alt="GOOGLE">
						 Google
					</a>
					...
					<div class="text-center w-full p-t-115">
						...
						<a class="txt1 bo1 hov1" href="{$PAG_CADASTRO}">
				            Cadastre-se						
						</a>
					</div>
					<div class="text-center w-full p-t-115">
						<a class="txt1 bo1 hov1" href="{$GET_SITE_HOME}/adm/login.php">
				            Administração					
						</a>
					</div>
				</form>
