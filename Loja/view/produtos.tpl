 ...
 <section class="bg0 p-t-23 p-b-140">
		<div class="container">
        	...
        	{/foreach}
				...
				<meta http-equiv="refresh" content=2;url="{$PAG_PRODUTOS}">
				{/if}
			{foreach $PRO item=P}
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="{$PRO_INFO}/{$P.pro_id}/{$P.pro_slug}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
								Visualizar
							</a>
						</div>
