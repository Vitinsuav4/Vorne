							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="{$P.pro_img}">
									<div class="wrap-pic-w pos-relative">
										<img src="{$P.pro_img}" alt="IMG-PRIN.">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{$P.pro_img}">
								...
								<div class="item-slick3" data-thumb="{$I.img_nome}">
									<div class="wrap-pic-w pos-relative">
										<img src="{$I.img_nome}" alt="IMG-SEC.">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{$I.img_nome}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<div class="flex-w flex-t p-b-68">
											<div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
												<img src="{$GET_SITE_HOME}/media/neymar.webp" alt="AVATAR">
											</div>
