...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="{$GET_SITE_HOME}/lib/paginas/cadastro/fonts/material-icon/css/material-design-iconic-font.min.css">

    <!-- Main css -->
    <link rel="stylesheet" href="{$GET_SITE_HOME}/lib/paginas/cadastro/css/style.css">
</head>
<body>
        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-img">
                   <img style="height: 97%;" src="{$GET_SITE_HOME}/lib/paginas/cadastro/images.jfif" alt="">
                </div>
    ...
    <!-- JS -->
    <script src="{$GET_SITE_HOME}/lib/paginas/cadastro/vendor/jquery/jquery.min.js"></script>
    <script src="{$GET_SITE_HOME}/lib/paginas/cadastro/js/main.js"></script>
</body>
</html>