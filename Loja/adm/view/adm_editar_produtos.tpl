...
<script src="https://cdn.tiny.cloud/1/i7xhmo7imtecffs0hmwek6wtjfi7j4fxrbd8wmke2rq1ynbt/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<script>
    tinymce.init({
      selector: '#pro_desc',
...
<section class="row" id="camposproduto">
    ...
    <form name="frm_produto" method="post" action=""  enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
               <hr> 
               <img src="{$PRO.1.pro_img}" class="thumbnail" alt="" height="170" width="170">
