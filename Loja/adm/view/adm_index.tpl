            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{$GET_SITE_HOME}">Ir para Loja</a>
                        <a class="dropdown-item" href="{$PAG_SENHA}">Alterar Senha</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{$GET_SITE_ADM}/adm_principal">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Área Principal
                            </a>
                            <div class="sb-sidenav-menu-heading">Edição e criação de conteúdos</div>
                            <a class="nav-link collapsed" href="{$PAG_ADM_PRODUTOS}">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Gerenciamento de Produtos
                            </a>
                            <a class="nav-link" href="{$GET_SITE_ADM}/adm_novos_produtos">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Criação de Produtos
                            </a> 
                            <a class="nav-link" href="{$GET_SITE_ADM}/adm_categorias">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Categorias
                            </a>   
                            
                            <a class="nav-link" href="{$GET_SITE_ADM}/adm_clientes">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Clientes
                            </a> 

                            <a class="nav-link collapsed" href="{$PAG_ADM_PEDIDOS}">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Pedidos
                            </a>
